    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu" style="background-color: #483D8B;color:white;">
            <div class="sidebar-header" style="background-color: #483D8B;color:white;">
                <div class="logo">
                    ...
                    <input type="hidden" name="id_pengguna" id="id_pengguna" value="{{$datalogin->id_pengguna}}"/>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            @if ($datalogin->id_jabatan !=1)
                                                        ...
                                                        <li>
                                                            ...
                                                            <ul class="collapse">
                                                                ...
                                                                <li>
                                                                    <a href="{{ url('admin/anggaran-tahun') }}">
                                                        ...
                                                        <li>
                                                            <a href="#" aria-expanded="true"><i class="ti-money"></i><span>Pendapatan
                                                                </span></a>
                                                            <ul class="collapse">
                                                                {{-- // Menu Data Jabatan --}}
                                                                <li>
                                                        ...
                                                        <li>
                                                            <a href="#" aria-expanded="true"><i class="ti-shopping-cart"></i><span>Belanja
                                                                </span></a>
                            ...
                            <li>
                                <a href="#" aria-expanded="true"><i class="ti-clipboard"></i><span>Laporan
                                    </span></a>

                                {{-- // Sub Menu Data Master --}}
                                <ul class="collapse">
                                    <li>
                                        <a href="{{ url('admin/rak/laporan') }}">
                                            <i class="ti-user" aria-hidden="true"></i>
                                            <span>RAK Desa </span>
                                        </a>
                                    </li>
                                    {{-- <li>
                                        <a href="{{ url('admin/rap/laporan') }}">
                                            <i class="ti-user" aria-hidden="true"></i>
                                            <span>RAP Desa </span>
                                        </a>
                                    </li> --}}
                            ...
                            <li>
                                <a href="{{ url("admin/pengaturan")}}" aria-expanded="true"><i class="ti-settings"></i><span>Pengaturan
                                    </span></a>
                            </li>
                            {{--  --}}
        ...
        <footer>
            <div class="footer-area">
                <p class="poppins">© Copyright 2023. All right reserved. Template by <a href="">IT KREATIF</a>.
                </p>
            </div>
        </footer>
        <!-- footer area end-->
